...
var _user$project$Model$Person = F4(
	function (a, b, c, d) {
		return {role: a, name: b, gender: c, sideOfConversation: d};
	});
var _user$project$Model$SideOfConversation = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {stance: a, reason1: b, reason2: c, reason3: d, empathy1: e, empathy2: f, empathy3: g, question1: h, question2: i, question3: j, answer1: k, answer2: l, answer3: m};
												};
											};
										};
									};
...
var _user$project$Model$Trans = {ctor: 'Trans'};
var _user$project$Model$Female = {ctor: 'Female'};
var _user$project$Model$Male = {ctor: 'Male'};
var _user$project$Model$Partner = {ctor: 'Partner'};
...
var _user$project$Update$parseLocation = function (location) {
	return A2(_evancz$url_parser$UrlParser$parsePath, _evancz$url_parser$UrlParser$string, location);
};
var _user$project$Update$sideOfConvDecoder = A3(
										...
										A3(
											...
											A3(
												...
												A3(
													...
													'stance',
													_elm_lang$core$Json_Decode$string,
													_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$SideOfConversation))))))))))))));
var _user$project$Update$genderDecoder = function (gender) {
	var _p0 = gender;
	switch (_p0) {
		case 'Male':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Male);
		case 'Female':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Female);
		case 'Trans':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Trans);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], gender, ' is not recognized for Gender'));
	}
};
var _user$project$Update$roleDecoder = function (role) {
	var _p1 = role;
	switch (_p1) {
		case 'Initiator':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Initiator);
		case 'Partner':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model$Partner);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], role, ' is not recognized for ConversationRole'));
	}
};
var _user$project$Update$personDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'sideOfConversation',
	_user$project$Update$sideOfConvDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'gender',
		A2(_elm_lang$core$Json_Decode$andThen, _user$project$Update$genderDecoder, _elm_lang$core$Json_Decode$string),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'name',
			_elm_lang$core$Json_Decode$string,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'role',
				A2(_elm_lang$core$Json_Decode$andThen, _user$project$Update$roleDecoder, _elm_lang$core$Json_Decode$string),
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Person)))));
var _user$project$Update$modelDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'partner',
	_user$project$Update$personDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'initiator',
		_user$project$Update$personDecoder,
...
var _user$project$Update$decodeConversationIntoElm = _elm_lang$core$Json_Decode$decodeValue(_user$project$Update$modelDecoder);
var _user$project$Update$sideOfConvToValue = function (sideOfConv) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'stance',
				_1: _elm_lang$core$Json_Encode$string(sideOfConv.stance)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'reason1',
					_1: _elm_lang$core$Json_Encode$string(sideOfConv.reason1)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'reason2',
						_1: _elm_lang$core$Json_Encode$string(sideOfConv.reason2)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'reason3',
							_1: _elm_lang$core$Json_Encode$string(sideOfConv.reason3)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'empathy1',
								_1: _elm_lang$core$Json_Encode$string(sideOfConv.empathy1)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'empathy2',
									_1: _elm_lang$core$Json_Encode$string(sideOfConv.empathy2)
								},
								_1: {
									ctor: '::',
									_0: {
...
var _user$project$Update$genderToValue = function (gender) {
	var _p2 = gender;
	switch (_p2.ctor) {
		case 'Male':
		...
		default:
			return _elm_lang$core$Json_Encode$string('Trans');
	}
};
var _user$project$Update$roleToValue = function (role) {
	var _p3 = role;
	if (_p3.ctor === 'Initiator') {
		return _elm_lang$core$Json_Encode$string('Initiator');
	} else {
		return _elm_lang$core$Json_Encode$string('Partner');
	}
};
var _user$project$Update$personToValue = function (person) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'role',
				_1: _user$project$Update$roleToValue(person.role)
			},
			_1: {
				ctor: '::',
				_0: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'gender',
						_1: _user$project$Update$genderToValue(person.gender)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'sideOfConversation',
							_1: _user$project$Update$sideOfConvToValue(person.sideOfConversation)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Update$modelToValue = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'firebaseKey',
				_1: _elm_lang$core$Json_Encode$string(model.firebaseKey)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'step',
					_1: _elm_lang$core$Json_Encode$int(model.step)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'topic',
						_1: _elm_lang$core$Json_Encode$string(model.topic)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'initiator',
							_1: _user$project$Update$personToValue(model.initiator)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'partner',
								_1: _user$project$Update$personToValue(model.partner)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Update$updateSideOfConversation = F2(
	function (conversationMsg, conversation) {
		var _p4 = conversationMsg;
		switch (_p4.ctor) {
			case 'Stance':
				return _elm_lang$core$Native_Utils.update(
					conversation,
...
var _user$project$Update$updatePerson = F2(
	function (personMsg, person) {
		var _p5 = personMsg;
		switch (_p5.ctor) {
			case 'NameUpdate':
				return _elm_lang$core$Native_Utils.update(
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					person,
					{
						sideOfConversation: A2(_user$project$Update$updateSideOfConversation, _p5._0, person.sideOfConversation)
					});
		}
	});
var _user$project$Update$getPersonToUpdate = F2(
	function (role, model) {
		var _p6 = role;
		if (_p6.ctor === 'Initiator') {
			return model.initiator;
		} else {
			return model.partner;
		}
	});
var _user$project$Update$saveConversation = _elm_lang$core$Native_Platform.outgoingPort(
	'saveConversation',
	function (v) {
		return v;
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			case 'SetStep':
				var _p8 = _p7._0;
				var modelAsValue = _user$project$Update$modelToValue(
					_elm_lang$core$Native_Utils.update(
						model,
						{step: _p8}));
				var cmdToRun = _user$project$Update$saveConversation(modelAsValue);
				return {
					ctor: '_Tuple2',
			...
			case 'ConversationTopic':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{topic: _p7._0, partner: model.partner}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InitiatorUpdate':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							initiator: A2(_user$project$Update$updatePerson, _p7._0, model.initiator)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PartnerUpdate':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							partner: A2(_user$project$Update$updatePerson, _p7._0, model.partner)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UrlChange':
...
var _user$project$Update$getFirebaseKey = _elm_lang$core$Native_Platform.incomingPort('getFirebaseKey', _elm_lang$core$Json_Decode$string);
var _user$project$Update$getConversationFromFirebase = _elm_lang$core$Native_Platform.outgoingPort(
	'getConversationFromFirebase',
	function (v) {
		return v;
	});
var _user$project$Update$sendConversationIntoElm = _elm_lang$core$Native_Platform.incomingPort('sendConversationIntoElm', _elm_lang$core$Json_Decode$value);
var _user$project$Update$LoadConversation = function (a) {
	return {ctor: 'LoadConversation', _0: a};
};
var _user$project$Update$GetFirebaseKey = function (a) {
	return {ctor: 'GetFirebaseKey', _0: a};
};
var _user$project$Update$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Update$PartnerUpdate = function (a) {
	return {ctor: 'PartnerUpdate', _0: a};
};
var _user$project$Update$InitiatorUpdate = function (a) {
	return {ctor: 'InitiatorUpdate', _0: a};
};
var _user$project$Update$ConversationTopic = function (a) {
	return {ctor: 'ConversationTopic', _0: a};
};
var _user$project$Update$SetStep = function (a) {
	return {ctor: 'SetStep', _0: a};
};
var _user$project$Update$ConversationUpdate = function (a) {
	return {ctor: 'ConversationUpdate', _0: a};
};
var _user$project$Update$GenderUpdate = function (a) {
	return {ctor: 'GenderUpdate', _0: a};
};
var _user$project$Update$NameUpdate = function (a) {
	return {ctor: 'NameUpdate', _0: a};
};
var _user$project$Update$Answer3 = function (a) {
	return {ctor: 'Answer3', _0: a};
};
var _user$project$Update$Answer2 = function (a) {
	return {ctor: 'Answer2', _0: a};
};
var _user$project$Update$Answer1 = function (a) {
	return {ctor: 'Answer1', _0: a};
};
var _user$project$Update$Question3 = function (a) {
	return {ctor: 'Question3', _0: a};
};
var _user$project$Update$Question2 = function (a) {
	return {ctor: 'Question2', _0: a};
};
var _user$project$Update$Question1 = function (a) {
	return {ctor: 'Question1', _0: a};
};
var _user$project$Update$Empathy3 = function (a) {
	return {ctor: 'Empathy3', _0: a};
};
var _user$project$Update$Empathy2 = function (a) {
	return {ctor: 'Empathy2', _0: a};
};
var _user$project$Update$Empathy1 = function (a) {
	return {ctor: 'Empathy1', _0: a};
};
var _user$project$Update$Reason3 = function (a) {
	return {ctor: 'Reason3', _0: a};
};
var _user$project$Update$Reason2 = function (a) {
	return {ctor: 'Reason2', _0: a};
};
var _user$project$Update$Reason1 = function (a) {
	return {ctor: 'Reason1', _0: a};
};
var _user$project$Update$Stance = function (a) {
	return {ctor: 'Stance', _0: a};
};

var _user$project$MyCss$sideOfConversation = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		...
		_1: {
			...
			_0: _rtfeldman$elm_css$Css$backgroundColor(
				A3(_rtfeldman$elm_css$Css$rgb, 245, 255, 250)),
			_1: {
				ctor: '::',
				_0: A3(
...
var _user$project$MyCss$inputTextStyle = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$MyCss$QuestionsSection = {ctor: 'QuestionsSection'};
var _user$project$MyCss$PassToOtherPersonSender = {ctor: 'PassToOtherPersonSender'};
var _user$project$MyCss$PassToOtherPerson = {ctor: 'PassToOtherPerson'};
var _user$project$MyCss$QuestionLabel = {ctor: 'QuestionLabel'};
var _user$project$MyCss$Question = {ctor: 'Question'};
var _user$project$MyCss$QuestionInput = {ctor: 'QuestionInput'};
var _user$project$MyCss$InputText = {ctor: 'InputText'};
var _user$project$MyCss$Partner = {ctor: 'Partner'};
var _user$project$MyCss$Initiator = {ctor: 'Initiator'};
var _user$project$MyCss$SideOfConversation = {ctor: 'SideOfConversation'};
var _user$project$MyCss$Topic = {ctor: 'Topic'};
var _user$project$MyCss$IntroSentence = {ctor: 'IntroSentence'};
var _user$project$MyCss$SectionHeading = {ctor: 'SectionHeading'};
var _user$project$MyCss$CurrentStep = {ctor: 'CurrentStep'};
var _user$project$MyCss$BackNextButton = {ctor: 'BackNextButton'};
var _user$project$MyCss$BackNextButtonGroup = {ctor: 'BackNextButtonGroup'};
var _user$project$MyCss$ConversationContainer = {ctor: 'ConversationContainer'};
var _user$project$MyCss$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'benvolio-', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$MyCss$ConversationContainer,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$maxWidth(
					_rtfeldman$elm_css$Css$px(700)),
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$MyCss$BackNextButtonGroup,
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$MyCss$BackNextButton,
					{
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Css$padding2,
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$MyCss$CurrentStep,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$marginTop(
								_rtfeldman$elm_css$Css$px(20)),
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_user$project$MyCss$SectionHeading,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$marginBottom(
									_rtfeldman$elm_css$Css$px(30)),
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_user$project$MyCss$IntroSentence,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$marginBottom(
										_rtfeldman$elm_css$Css$px(20)),
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$MyCss$SideOfConversation,
										{
											ctor: '::',
											_0: _user$project$MyCss$sideOfConversation,
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_user$project$MyCss$Initiator,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$borderColor(_rtfeldman$elm_css$Css_Colors$green),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$backgroundColor(
														A3(_rtfeldman$elm_css$Css$rgb, 245, 255, 250)),
										...
										_1: {
											...
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												_user$project$MyCss$Partner,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$borderColor(
														_rtfeldman$elm_css$Css$hex('2b98e2')),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$backgroundColor(
															A3(_rtfeldman$elm_css$Css$rgb, 240, 248, 255)),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												...
												_0: A2(
													_rtfeldman$elm_css$Css$class,
													_user$project$MyCss$InputText,
													{
														ctor: '::',
														_0: _user$project$MyCss$inputTextStyle,
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_0: A2(
															_rtfeldman$elm_css$Css$class,
															_user$project$MyCss$QuestionLabel,
															{ctor: '[]'}),
														_1: {
															ctor: '::',
															_0: A2(
																_rtfeldman$elm_css$Css$class,
																_user$project$MyCss$QuestionInput,
																{
																	ctor: '::',
																	_0: _user$project$MyCss$inputTextStyle,
																	_1: {ctor: '[]'}
															...
															_1: {
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	_user$project$MyCss$PassToOtherPerson,
																	{
																		ctor: '::',
																		...
																		_1: {
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$backgroundColor(
																				A4(_rtfeldman$elm_css$Css$rgba, 255, 220, 0, 0.11)),
																			_1: {
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$padding(
																					_rtfeldman$elm_css$Css$px(10)),
																...
																_1: {
																	...
																	_0: A2(
																		_rtfeldman$elm_css$Css$class,
																		_user$project$MyCss$PassToOtherPersonSender,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$marginBottom(
																				_rtfeldman$elm_css$Css$px(20)),
																	...
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_user$project$MyCss$QuestionsSection,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$marginBottom(
																					_rtfeldman$elm_css$Css$px(30)),
...
var _user$project$QuestionAnswerText$Answer = {ctor: 'Answer'};
var _user$project$QuestionAnswerText$Question = {ctor: 'Question'};
var _user$project$QuestionAnswerText$QuestionAnswerSet = {ctor: 'QuestionAnswerSet'};
var _user$project$QuestionAnswerText$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'benvolio-', _p0));
}(
	{
		...
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$QuestionAnswerText$QuestionAnswerSet,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$marginBottom(
					_rtfeldman$elm_css$Css$px(20)),
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$QuestionAnswerText$Question,
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$QuestionAnswerText$Answer,
					{
						ctor: '::',
...
var _user$project$View$viewListOfReasons = function (reasons) {
	return A2(
		...
		A2(
			...
			A2(
				...
				A2(_elm_lang$core$List$map, _elm_lang$html$Html$text, reasons))));
};
var _user$project$View$capitalize = function (str) {
...
var _user$project$View$herHim = function (gender) {
	var _p1 = gender;
	switch (_p1.ctor) {
		case 'Female':
			return 'her';
...
var _user$project$View$herHis = function (gender) {
	var _p2 = gender;
	switch (_p2.ctor) {
		case 'Female':
			return 'her';
...
var _user$project$View$sheHe = function (gender) {
	var _p3 = gender;
	switch (_p3.ctor) {
		case 'Female':
			return 'she';
...
var _user$project$View$viewQuestionsSummary = function (sideOfConv) {
	return (!_elm_lang$core$Native_Utils.eq(sideOfConv.question1, '')) ? A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(sideOfConv.question1),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(sideOfConv.question2),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(sideOfConv.question3),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$viewEmpathySummary = F3(
	function (model, role, labelOn) {
		var empathizee = _elm_lang$core$Native_Utils.eq(role, _user$project$Model$Initiator) ? model.partner : model.initiator;
		var empathizer = _elm_lang$core$Native_Utils.eq(role, _user$project$Model$Initiator) ? model.initiator : model.partner;
		var label = labelOn ? _elm_lang$html$Html$text(
			A2(
				_elm_lang$core$Basics_ops['++'],
				empathizer.name,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'\'s empathy for ',
					A2(_elm_lang$core$Basics_ops['++'], empathizee.name, '\'s reasons:')))) : _elm_lang$html$Html$text('');
		return (!_elm_lang$core$Native_Utils.eq(empathizer.sideOfConversation.empathy1, '')) ? A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											empathizee.name,
											A2(_elm_lang$core$Basics_ops['++'], ': ', empathizee.sideOfConversation.reason1))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												empathizer.name,
												A2(_elm_lang$core$Basics_ops['++'], ': ', empathizer.sideOfConversation.empathy1))),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_0: _elm_lang$html$Html$text(
													A2(
														_elm_lang$core$Basics_ops['++'],
														empathizee.name,
														A2(_elm_lang$core$Basics_ops['++'], ': ', empathizee.sideOfConversation.reason2))),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															empathizer.name,
															A2(_elm_lang$core$Basics_ops['++'], ': ', empathizer.sideOfConversation.empathy2))),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
														...
														{ctor: '[]'},
														{
															...
															_0: _elm_lang$html$Html$text(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	empathizee.name,
																	A2(_elm_lang$core$Basics_ops['++'], ': ', empathizee.sideOfConversation.reason3))),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
															...
															{ctor: '[]'},
															{
																...
																_0: _elm_lang$html$Html$text(
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		empathizer.name,
																		A2(_elm_lang$core$Basics_ops['++'], ': ', empathizer.sideOfConversation.empathy3))),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('No empathy entered'),
				_1: {ctor: '[]'}
			});
	});
var _user$project$View$viewReasonsSummary = function (person) {
	return (!_elm_lang$core$Native_Utils.eq(person.sideOfConversation.reason1, '')) ? A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Reasons ',
					A2(_elm_lang$core$Basics_ops['++'], person.name, ' holds this stance are: '))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$ul,
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(person.sideOfConversation.reason1),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(person.sideOfConversation.reason2),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(person.sideOfConversation.reason3),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$View$viewStanceSummary = function (person) {
	return (!_elm_lang$core$Native_Utils.eq(person.sideOfConversation.stance, '')) ? _elm_lang$html$Html$text(
		A2(
			_elm_lang$core$Basics_ops['++'],
			person.name,
			A2(
				_elm_lang$core$Basics_ops['++'],
				'\'s stance is \"',
				A2(_elm_lang$core$Basics_ops['++'], person.sideOfConversation.stance, '\"')))) : _elm_lang$html$Html$text('');
};
var _user$project$View$viewPersonGender = function (person) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$checked(
									_elm_lang$core$Native_Utils.eq(person.gender, _user$project$Model$Male)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Update$GenderUpdate(_user$project$Model$Male)),
									_1: {ctor: '[]'}
								}
							}
						},
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$checked(
										_elm_lang$core$Native_Utils.eq(person.gender, _user$project$Model$Female)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Update$GenderUpdate(_user$project$Model$Female)),
										_1: {ctor: '[]'}
									}
								}
							},
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$checked(
											_elm_lang$core$Native_Utils.eq(person.gender, _user$project$Model$Trans)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Update$GenderUpdate(_user$project$Model$Trans)),
											_1: {ctor: '[]'}
										}
									}
								},
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('Trans'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$View$_p4 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('benvolio-');
var _user$project$View$id = _user$project$View$_p4.id;
var _user$project$View$class = _user$project$View$_p4.$class;
var _user$project$View$classList = _user$project$View$_p4.classList;
var _user$project$View$viewPersonName = function (person) {
	return A2(
		_elm_lang$html$Html$input,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$NameUpdate),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(person.name),
				_1: {
					ctor: '::',
					_0: _user$project$View$class(
						{
							ctor: '::',
							_0: _user$project$MyCss$InputText,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$viewPersonStance = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			_elm_lang$html$Html$input,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Stance),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.stance),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonReason1 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Reason1),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.reason1),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonReason2 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Reason2),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.reason2),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonReason3 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Reason3),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.reason3),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonEmpathy1 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Empathy1),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.empathy1),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonEmpathy2 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Empathy2),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.empathy2),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonEmpathy3 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Empathy3),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.empathy3),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
...
var _user$project$View$viewPersonQuestion1 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Question1),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.question1),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$size(100),
						_1: {
							ctor: '::',
							_0: _user$project$View$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$QuestionInput,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$viewPersonQuestion2 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Question2),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.question2),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$size(100),
						_1: {
...
var _user$project$View$viewPersonQuestion3 = function (person) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Update$ConversationUpdate,
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Question3),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(person.sideOfConversation.question3),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$size(100),
						_1: {
...
var _user$project$View$viewFirstConversationSummary = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
					...
					_0: _user$project$View$class(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$MyCss$Initiator,
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _user$project$View$viewStanceSummary(model.initiator),
					_1: {
						ctor: '::',
						_0: _user$project$View$viewReasonsSummary(model.initiator),
						_1: {
							ctor: '::',
							_0: A3(_user$project$View$viewEmpathySummary, model, _user$project$Model$Initiator, true),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				...
				_0: A2(
						...
						_0: _user$project$View$class(
							{
								...
								_1: {
									ctor: '::',
									_0: _user$project$MyCss$Partner,
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
					...
					{
						ctor: '::',
						_0: _user$project$View$viewStanceSummary(model.partner),
						_1: {
							ctor: '::',
							_0: _user$project$View$viewReasonsSummary(model.partner),
							_1: {
								ctor: '::',
								_0: A3(_user$project$View$viewEmpathySummary, model, _user$project$Model$Partner, true),
								_1: {ctor: '[]'}
							}
						}
					}),
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$View$class(
							{
								ctor: '::',
								_0: _user$project$MyCss$QuestionsSection,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_user$project$View$herHis(questionAnswerer.gender),
											A2(
												_elm_lang$core$Basics_ops['++'],
					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'What are three questions you have for ',
									A2(_elm_lang$core$Basics_ops['++'], questionAnswerer.name, '?'))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View$viewQuestionsAndAnswers = F2(
	function (asker, answerer) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
						...
						_0: A2(
							_elm_lang$html$Html$li,
							{
								...
								_0: _user$project$View$class(
									{
										ctor: '::',
										_0: _user$project$QuestionAnswerText$QuestionAnswerSet,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
								...
								_0: A2(
									_elm_lang$html$Html$span,
									{
										...
										_0: _user$project$View$class(
											{
												ctor: '::',
												_0: _user$project$QuestionAnswerText$Question,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(asker.sideOfConversation.question1),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$li,
										{
											...
											_0: _user$project$View$class(
												{
													ctor: '::',
													_0: _user$project$QuestionAnswerText$Answer,
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(answerer.sideOfConversation.answer1),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(asker.sideOfConversation.question2),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(answerer.sideOfConversation.answer2),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(asker.sideOfConversation.question3),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(answerer.sideOfConversation.answer3),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$View$viewQuestionsAndAnswersWithCaption = F2(
	function (asker, answerer) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
				...
				_0: _elm_lang$html$Html$text(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'\'s questions and ',
							A2(_elm_lang$core$Basics_ops['++'], answerer.name, '\'s answers')))),
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$viewQuestionsAndAnswers, asker, answerer),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View$viewQuestionsReadyToAnswer = F2(
	function (sideOfConv1, sideOfConv2) {
		return A2(
			_elm_lang$html$Html$map,
			_user$project$Update$ConversationUpdate,
			A2(
					...
					_0: A2(
						_elm_lang$html$Html$li,
						{
							...
							_0: _user$project$View$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$Question,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(sideOfConv1.question1),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Answer1),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(sideOfConv2.answer1),
											_1: {
												ctor: '::',
												_0: _user$project$View$class(
													{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(sideOfConv1.question2),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Answer2),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(sideOfConv2.answer2),
												_1: {
													ctor: '::',
													_0: _user$project$View$class(
														{
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(sideOfConv1.question3),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$Answer3),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(sideOfConv2.answer3),
													_1: {
														ctor: '::',
														_0: _user$project$View$class(
															{
...
var _user$project$View$viewReceiverAnswersQuestions = F2(
	function (sender, receiver) {
		var updateMsg = _elm_lang$core$Native_Utils.eq(receiver.role, _user$project$Model$Initiator) ? _user$project$Update$InitiatorUpdate : _user$project$Update$PartnerUpdate;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$map,
								updateMsg,
								A2(_user$project$View$viewQuestionsReadyToAnswer, sender.sideOfConversation, receiver.sideOfConversation)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$viewQuestionSectionSummary = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$View$viewQuestionsAndAnswersWithCaption, model.initiator, model.partner),
							_1: {ctor: '[]'}
						}
					}
				}),
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$View$viewQuestionsAndAnswersWithCaption, model.partner, model.initiator),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$View$instructionsForTransferToOtherPerson = F2(
	function (sender, receiver) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
								...
								A2(
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_user$project$View$herHim(receiver.gender),
				...
				_1: {
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], receiver.name, ': Go ahead and press the \'Next\' button.')),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$viewQuestionsSummaryBeforeSend = F2(
	function (sender, receiver) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'Here are the questions you\'re going to send to ',
						A2(_elm_lang$core$Basics_ops['++'], receiver.name, ':'))),
				_1: {
					ctor: '::',
					_0: _user$project$View$viewQuestionsSummary(sender.sideOfConversation),
					_1: {
						ctor: '::',
						_0: A2(_user$project$View$instructionsForTransferToOtherPerson, sender, receiver),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$View$viewStep = function (model) {
	var _p5 = model.step;
	switch (_p5) {
		case 1:
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Hi! Benvolio is a website that helps two people understand each other better. '),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('What topic would you like to discuss?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$ConversationTopic),
									_1: {
										ctor: '::',
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('What\'s your first name?'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$map,
							_user$project$Update$InitiatorUpdate,
							_user$project$View$viewPersonName(model.initiator)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('And what\'s your gender?'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$map,
											_user$project$Update$InitiatorUpdate,
											_user$project$View$viewPersonGender(model.initiator)),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'And what\'s the first name of the person with whom you would like to discuss \"',
									A2(_elm_lang$core$Basics_ops['++'], model.topic, '\"?'))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$map,
									_user$project$Update$PartnerUpdate,
									_user$project$View$viewPersonName(model.partner)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('And what\'s this person\'s gender?'),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$map,
											_user$project$Update$PartnerUpdate,
											_user$project$View$viewPersonGender(model.partner)),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$map,
								_user$project$Update$InitiatorUpdate,
								_user$project$View$viewPersonStance(model.initiator)),
							_1: {ctor: '[]'}
						}
					}
				});
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													'\" and your stance is \"',
													A2(_elm_lang$core$Basics_ops['++'], model.initiator.sideOfConversation.stance, '\".'))))))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('List 3 reasons why you hold your stance.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Reason 1:'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$map,
											_user$project$Update$InitiatorUpdate,
											_user$project$View$viewPersonReason1(model.initiator)),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Reason 2:'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$map,
												_user$project$Update$InitiatorUpdate,
												_user$project$View$viewPersonReason2(model.initiator)),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Reason 3:'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$map,
													_user$project$Update$InitiatorUpdate,
													_user$project$View$viewPersonReason3(model.initiator)),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													'\". You think \"',
													A2(_elm_lang$core$Basics_ops['++'], model.initiator.sideOfConversation.stance, '\" because: '))))))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$View$viewListOfReasons(
							{
								ctor: '::',
								_0: model.initiator.sideOfConversation.reason1,
								_1: {
									ctor: '::',
									_0: model.initiator.sideOfConversation.reason2,
									_1: {
										ctor: '::',
										_0: model.initiator.sideOfConversation.reason3,
										_1: {ctor: '[]'}
									}
								}
							}),
						_1: {
							ctor: '::',
							_0: A2(_user$project$View$instructionsForTransferToOtherPerson, model.initiator, model.partner),
							_1: {ctor: '[]'}
						}
					}
				});
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$map,
										_user$project$Update$PartnerUpdate,
										_user$project$View$viewPersonStance(model.partner)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'\" is \"',
									A2(_elm_lang$core$Basics_ops['++'], model.partner.sideOfConversation.stance, '\".'))))),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
										...
										{ctor: '[]'},
										{
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$map,
													_user$project$Update$PartnerUpdate,
													_user$project$View$viewPersonReason1(model.partner)),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
											...
											{ctor: '[]'},
											{
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$map,
														_user$project$Update$PartnerUpdate,
														_user$project$View$viewPersonReason2(model.partner)),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
												...
												{ctor: '[]'},
												{
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$map,
															_user$project$Update$PartnerUpdate,
															_user$project$View$viewPersonReason3(model.partner)),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											'. You think \"',
											A2(_elm_lang$core$Basics_ops['++'], model.partner.sideOfConversation.stance, '\" because :'))))))),
					_1: {
						ctor: '::',
						_0: _user$project$View$viewListOfReasons(
							{
								ctor: '::',
								_0: model.partner.sideOfConversation.reason1,
								_1: {
									ctor: '::',
									_0: model.partner.sideOfConversation.reason2,
									_1: {
										ctor: '::',
										_0: model.partner.sideOfConversation.reason3,
										_1: {ctor: '[]'}
									}
								}
							}),
						_1: {
							ctor: '::',
							_0: A2(_user$project$View$instructionsForTransferToOtherPerson, model.partner, model.initiator),
							_1: {ctor: '[]'}
						}
					}
				});
										...
										A2(
											...
											A2(
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_user$project$View$herHis(model.partner.gender),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' reasons why ',
															A2(
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											_elm_lang$html$Html$map,
											_user$project$Update$InitiatorUpdate,
											_user$project$View$viewPersonEmpathy1(model.initiator)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_elm_lang$html$Html$map,
												_user$project$Update$InitiatorUpdate,
												_user$project$View$viewPersonEmpathy2(model.initiator)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$map,
													_user$project$Update$InitiatorUpdate,
													_user$project$View$viewPersonEmpathy3(model.initiator)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A3(_user$project$View$viewEmpathySummary, model, _user$project$Model$Initiator, false),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								A2(
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_user$project$View$herHis(model.initiator.gender),
												A2(
													_elm_lang$core$Basics_ops['++'],
													' stance on \"',
													A2(_elm_lang$core$Basics_ops['++'], model.topic, '\".'))))))))),
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											_elm_lang$html$Html$map,
											_user$project$Update$PartnerUpdate,
											_user$project$View$viewPersonEmpathy1(model.partner)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_elm_lang$html$Html$map,
												_user$project$Update$PartnerUpdate,
												_user$project$View$viewPersonEmpathy2(model.partner)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$map,
													_user$project$Update$PartnerUpdate,
													_user$project$View$viewPersonEmpathy3(model.partner)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Here is a summary of your empathy for ',
							A2(_elm_lang$core$Basics_ops['++'], model.initiator.name, '\'s reasons: '))),
					_1: {
						ctor: '::',
						_0: A3(_user$project$View$viewEmpathySummary, model, _user$project$Model$Partner, false),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'! Below is ',
									A2(_elm_lang$core$Basics_ops['++'], model.partner.name, '\'s empathy for your reasons.'))))),
					_1: {
						ctor: '::',
						_0: A3(_user$project$View$viewEmpathySummary, model, _user$project$Model$Partner, false),
						_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$View$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$IntroSentence,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('You can stop here and view a final summary together, or you can proceed to the next phase where you pose questions to each other to further increase understanding.'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Topic: ', model.topic)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$View$viewFirstConversationSummary(model),
							_1: {ctor: '[]'}
						}
					}
				});
		case 20:
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View$viewQuestionsPlusText, model.initiator, model.partner),
					_1: {ctor: '[]'}
				});
		case 21:
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View$viewQuestionsSummaryBeforeSend, model.initiator, model.partner),
					_1: {ctor: '[]'}
				});
		case 22:
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View$viewReceiverAnswersQuestions, model.initiator, model.partner),
					_1: {ctor: '[]'}
				});
		case 23:
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View$viewQuestionsPlusText, model.partner, model.initiator),
					_1: {ctor: '[]'}
				});
		case 24:
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View$viewQuestionsSummaryBeforeSend, model.partner, model.initiator),
					_1: {ctor: '[]'}
				});
		case 25:
			return A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$View$viewReceiverAnswersQuestions, model.partner, model.initiator),
					_1: {ctor: '[]'}
				});
		case 26:
			return A2(
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								...
								A2(_elm_lang$core$Basics_ops['++'], model.partner.name, '\'s questions.')))),
					_1: {
						ctor: '::',
						_0: A2(_user$project$View$viewQuestionsAndAnswers, model.partner, model.initiator),
						_1: {
							ctor: '::',
							_0: A2(_user$project$View$instructionsForTransferToOtherPerson, model.initiator, model.partner),
							_1: {ctor: '[]'}
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								', here are ',
								A2(_elm_lang$core$Basics_ops['++'], model.initiator.name, '\'s answers to your questions.')))),
					_1: {
						ctor: '::',
						_0: A2(_user$project$View$viewQuestionsAndAnswers, model.partner, model.initiator),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Click \'Next\' to view a summary of the Question and Answer Section'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$View$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$SectionHeading,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Question and Answer Section summary'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _user$project$View$viewQuestionSectionSummary(model),
							_1: {
								ctor: '::',
								_0: A2(_user$project$View$instructionsForTransferToOtherPerson, model.partner, model.initiator),
								_1: {ctor: '[]'}
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('undefined step'),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$View$viewNextBackButtons = function (currentStep) {
	return (_elm_lang$core$Native_Utils.cmp(currentStep, 1) > 0) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$View$class(
				{
					ctor: '::',
					_0: _user$project$MyCss$BackNextButtonGroup,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Update$SetStep(currentStep - 1)),
					_1: {
						ctor: '::',
						_0: _user$project$View$class(
							{
								ctor: '::',
								_0: _user$project$MyCss$BackNextButton,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$View$class(
								{
									ctor: '::',
									_0: _user$project$MyCss$CurrentStep,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'current step: ',
									_elm_lang$core$Basics$toString(currentStep))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _user$project$View$class(
				{
					ctor: '::',
					_0: _user$project$MyCss$ConversationContainer,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$viewStep(model),
			_1: {
				ctor: '::',
				_0: _user$project$View$viewNextBackButtons(model.step),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Update$getFirebaseKey(_user$project$Update$GetFirebaseKey),
			_1: {
				ctor: '::',
				_0: _user$project$Update$sendConversationIntoElm(
					function (_p0) {
						return _user$project$Update$LoadConversation(
							_user$project$Update$decodeConversationIntoElm(_p0));
					}),
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Main$init = function (location) {
	...
	var fetchModelUsingFirebaseKey = function () {
		...
		if (_p0.ctor === 'Just') {
			return _user$project$Update$getConversationFromFirebase(
				_elm_lang$core$Json_Encode$string(_p0._0));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	}();
	return {ctor: '_Tuple2', _0: _user$project$Model$initialModel, _1: fetchModelUsingFirebaseKey};
};
var _user$project$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Update$UrlChange,
	{view: _user$project$View$view, update: _user$project$Update$update, init: _user$project$Main$init, subscriptions: _user$project$Subscriptions$subscriptions})();
